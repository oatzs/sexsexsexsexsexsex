...
PasswordsAccounts(){
	...
	sudo apt-fast install grub-common -y
	sudo echo "if [ \"0\" -eq \"1\" ];
	then
	set superusers=\"root\"
	password_pbkdf2 root grub.pbkdf2.sha512.10000.DFEDC1D819A260196186F3CBE7F761CA45F657BCE8AF578A2B8A50098C02678A78E3BC060455392B0ED7630A204063CFC3FDEED1EFE2BE39FD99BE9AB67F9C01.F8D56142893FCA46E13D8DF62E8A6F09F50B31D7E5251EE298A2365A01183790D79DCA26CD7E3ACB2634F53FC2FFF21D80797B5F3566A20B5CDF722710458125
	fi" | sudo tee -a /etc/grub.d/40_custom
	sudo update-grub
	sudo update-grub2
